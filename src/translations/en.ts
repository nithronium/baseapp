...
export const en = {
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.modalBody': 'Please contact administrator to disable',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.header.signUp.corporateLink': 'Looking to set up a corporate account? Press here!',
    ...
    'page.password2fa.text': 'Can\'t sign in with 2FA code?',
    'page.password2fa.link1': 'Lost access to device with GA/Authy?',
    'page.password2fa.link2': 'My 2FA code is invalid',
    ...
    'account.deposit.not_permitted': 'Generating deposit address',
