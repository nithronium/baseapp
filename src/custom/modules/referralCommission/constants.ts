...
export const REFERRAL_COMMISSION_PARTICIPANTS_FETCH = 'referralCommission/PARTICIPANTS_FETCH';
...
export const REFERRAL_COMMISSION_PARTICIPANTS_DATA = 'referralCommission/PARTICIPANTS_DATA';
