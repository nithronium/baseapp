...
const Prizes: React.FC = () => {
  return (
    <section id="prizes">
      <h2 className="center">Our 100 <span className="gold">prizes</span></h2>
        ...
        <div className="prize-container">
          <div className="prize_">
            ...
            <div className="bitcoin-emirex">
              $1,500<span className="explanation"> in Bitcoin <span className="gold">+</span> in EMRX</span>
            </div>
          </div>
        </div>
      </div>
