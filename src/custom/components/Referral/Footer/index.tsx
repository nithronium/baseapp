...
const links3 = [
    ...
    { key: '', href: '/trading/btcusdt', label: 'footer_links_buyTether'},
    { key: '', href: '/trading/usdcusdt', label: 'footer_links_buyUSDCoin'},
    { key: '', href: '/trading/btcusdt', label: 'footer_links_buyBlockburn'},
    { key: '', href: '/trading/emrxbtc', label: 'footer_links_buyEmirex'},
    { key: '', href: '/trading/ltcbtc', label: 'footer_links_buyLitecoin'},
    { key: '', href: '/trading/bchbtc', label: 'footer_links_buyBitcoinCash'},
    { key: '', href: '/trading/t69usdt', label: 'footer_links_buyT69Coin'},
