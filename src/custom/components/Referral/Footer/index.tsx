    ...
    return (
        <div className="medialogo">
            ...
            <div className="logo-wrapper">
                {/*<noindex>*/}
                <span className={'hlink'} rel = 'nofollow'
                ...
                <img src={coinspeaker} alt="coinspeaker logo" />
                    ...
                    {/*<noindex>*/}
                    <span className={'hlink'} rel= 'nofollow'
                          data-href={btoa('https://cointelegraph.com/news/us-fed-weighs-up-potential-cbdc-as-countermove-against-china')}>
                <img src={cointelegraph} alt="new btc logo" />
            </span>
                    {/*</noindex>*/}
                    {/*<noindex>*/}
                    <span className={'hlink'} rel='nofollow'
                          data-href={btoa('https://forbesmiddleeast.com/what-impact-could-tokenized-commodities-have-on-the-middle-east')}>
                <img src={forbes} alt="yahoo logo" />
            </span>
                    {/*</noindex>*/}
                    {/*<noindex>*/}
                    <span className={'hlink'} rel = 'nofollow'
                          data-href={btoa('https://www.newsbtc.com/2019/11/26/emirex-doubles-down-with-ieo-announcement-building-a-comprehensive-crypto-ecosystem-in-the-middle-east/')}>
