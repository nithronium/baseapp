                ...
                <div className="container">
                    <div className="left">
                        ...
                        <p>
                            ...
                            ensure complete transparency and independence. The draw will take place in Estonia, under the relevant
                            EU rules.{' '}
                        </p>
                        <p>
                            To ensure that there is no fraud, only tickets activated by accounts with a portfolio balance of at
                            least 50 USD OR 25 USD worth of EMRX at the time of the draw will count as valid.
                        </p>
