...
export const en = {
  ...
  'page.body.wallets.tabs.deposit.fiat.beneficiary.aed.value': 'BITMEEX FZE',
    ...
    'page.referal.bottombanner.accepted_cur_value': 'EMRX can be purchased for USDT, however, you can exchange BTC, ETH, EUR, USD, USDC, LTC, BCH to USDT and then purchase EMRX',  
