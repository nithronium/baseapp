...
export const en = {
    ...
    'page.body.profile.header.account.auth2fa.mfa.text2': 'In the next step you will be asked to ',
    'page.body.profile.header.account.auth2fa.mfa.text3': ' save your secret MFA code ',
    'page.body.profile.header.account.auth2fa.mfa.text4': 'Please note that this is ',
    'page.body.profile.header.account.auth2fa.mfa.text5': ' very important!',
    'page.body.profile.header.account.auth2fa.mfa.text6': 'MFA code is ',
    'page.body.profile.header.account.auth2fa.mfa.text7': ' necessery to restore access ',
    'page.body.profile.header.account.auth2fa.mfa.text8': ' to the account on your own in case you ',
    'page.body.profile.header.account.auth2fa.mfa.text9': ' lose your phone or change it.',
    'page.body.profile.header.account.auth2fa.mfa.text10': 'If you ',
    'page.body.profile.header.account.auth2fa.mfa.text11': ' lost access ',
    'page.body.profile.header.account.auth2fa.mfa.text12': ' to the device with GA installed and ',
    'page.body.profile.header.account.auth2fa.mfa.text13': ' did not save your MFA code ',
    'page.body.profile.header.account.auth2fa.mfa.text14': ' gaining access to your account on Emirex can take ',
    'page.body.profile.header.account.auth2fa.mfa.text15': ' up to 10 days',
    ...
    'page.referal.bottombanner.IEO_round_now': '13 Mar - 28 Mar 2020',
    'page.referal.bottombanner.IEO_round_next': '28 Mar - 13 Apr 2020',
    ...
    maticbtc_title: 'MATIC to BTC. Matic Network Exchange | Emirex.com  ',
    maticbtc_description: 'MATIC to BTC (Bitcoin) exchange rate ➤ Check price movements, market and trading information ➤ Matic Network charts and latest news ➤ Start trading now',
    maticusdt_title: 'MATIC to USDT. Price Matic Network | Emirex.com',
    maticusdt_description: 'MATIC/USDT price, charts, volume ➤ Check market and trading information ➤ Matic Network convert to Tether (USDT) ➤ Start trading now',
    zpaebtc_title: 'ZPAYae to Bitcoin (BTC). Live price, charts | Emirex.com   ',
    zpaebtc_description: 'Exchange ZelaaPay (ZPAYae) to Bitcoin (BTC) online instantly ➤ Get full information ➤ Prices and charts live ➤ Choose the best offer and start trading now',
    ...
    chzusdt_title: 'CHZ to USDT. Chiliz Exchange | Emirex.com',
    chzusdt_description: 'CHZ/USDT exchange charts ➤ Trade history, price ➤ Convert Chiliz (CHZ) to Tether (USDT) online ➤ Start investing now with Emirex',
    ethbusd_title: 'ETH/BUSD. Ethereum Binance USD Market | Emirex.com',
    ethbusd_description: 'ETH/BUSD markets. Ethereum to Binance USD convert on exchange platform ➤ Real time prices and ETH/BUSD charts ➤ Choose the best offer and start trading now',
    btcbusd_title: 'BTC/BUSD. Binance USD Markets | Emirex.com',
    btcbusd_description: 'BTC/BUSD markets. Bitcoin to Binance USD converter on exchange platform Emirex ➤ Real time prices and charts ➤ Choose the best offer and start trading now',
    enjbtc_title: 'Enjin Coin to BTC (ENJ/BTC) Exchange | Emirex.com',
    enjbtc_description: 'ENJ/BTC converter. View live Enjin Coin (ENJ) to Bitcoin (BTC) chart to track latest price changes ➤ Choose the best offer and start trading now',
    enjusdt_title: 'Enjin Coin to Tether (ENJ/USDT) | Emirex.com ',
    enjusdt_description: 'ENJ/USDT convert. View live Enjin Coin (ENJ) to Tether (USDT) chart to track latest price changes ➤ Choose the best offer and start trading now',
    ...
    ieo_5_title: 'CHA Chatello IEO | Emirex.com',
    ieo_5_description: 'CHA Chatello IEO ✅ We launched IEO listing ➤ Chatello is a revolutionary application that allows social media presence to be monetized anywhere, anytime.',
    ...
    'buyWithCard.steps.footer1': '<span>Click</span> to make purchase',
    ...
    'chatello.steps.text2': 'you successfully registered on the website. The next step is to verify your identity to make a one-click purchase.',
    ...
    'chatello.steps.footer1': '<span>Click</span> to make the purchase',
    'chatello.steps.footer2': 'At the second step, you need to provide you address, phone number and ID document to confirm your identity.',
