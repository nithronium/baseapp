...
export const ru: LangType = {
 ...
 Если Вы забыли свой Секретный ключ, удалите его и создайте новую пару ключей.',
  ...
  'tickets.emrx': 'стоимость токенов EMRX',
    ...
    "btcucdt_descriptions": "BTC в USDT ✅ Конвертер Биткоин в Tether ➤ Выгодные курсы и цены в режиме реального времени ➤ Большие объемы торгов ➤ Полная поддержка 24/7",
    ...
    "ethbtc_descrption": "ETH в BTC ✅ Конвертер Эфириум в Биткоин ➤ Выгодные курсы и цены в режиме реального времени ➤ Покупка и продажа: быстро, надежно, проверено ➤ Поддержка 24/7",
    "emrxbtc_title": "EMRX в BTC. Конвертация EMRX | Emirex.com",
    "emrxbtc_descriptions": "EMRX в BTC ✅ Конвертер EMRX. Онлайн курс ➤ Выгодные рыночные цены в режиме реального времени ➤ Покупка и продажа: быстро, надежно, проверено ➤ Поддержка 24/7",
    "ltcbtc_title": "LTC в BTC. Конвертация. Онлайн курс | Emirex.com",
    "ltcbtc_descriptions": "LTC в BTC ✅ Конвертер Лайткоин. Большие объемы торгов ➤ Выгодные рыночные цены в режиме реального времени ➤ Быстро, надежно, проверено ➤ Поддержка 24/7",
    "bchbtc_title": "BCH в BTC. Конвертация Биткоин Кэш | Emirex.com",
    "bchbtc_descriptions": "BCH в BTC ✅ Конвертер Биткоин Кэш ➤ Обмен онлайн ➤ Большие объемы торгов ➤ Выгодные рыночные цены в режиме реального времени ➤ Быстро, надежно, проверено",
