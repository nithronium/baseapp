...
export const ru: LangType = {
 ...
 Если Вы забыли свой Секретный ключ, удалите его и создайте новую пару ключей.',
    ...
    ieo_5_title: 'Chatello IEO. Цена сейчас | Emirex.com',
    ieo_5_description: 'CHA Chatello IEO ✅ Мы запустили IEO листинг ➤ Это революционное приложение, позволяющее монетизировать присутствие в социальных сетях где и когда угодно',
