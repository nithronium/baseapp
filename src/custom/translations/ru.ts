...
export const ru: LangType = {
 ...
 Если Вы забыли свой Секретный ключ, удалите его и создайте новую пару ключей.',
  ...
  'page.body.wallets.tabs.deposit.fiat.levelLink': 'Пожалуйста, повысьте свой Уровень Верификации.',
    ...
    'page.referral.hiw.text2': 'Вы получите 2 билета за каждого реферала первой линии,  и 1 билет за каждого реферала второй линии. Дополнительно Вы получаете билеты за подписку в соцсетях и пополнение баланса!  ',
    ...
    'page.referal.bottombanner.accepted_cur_value': 'Токены EMRX могут быть приобретены за USDT, но Вы можете также обменять BTC, ETH, EUR, USD, EUR, USDC, LTC, BCH на USDT и приобрести EMRX',
    ...
    'get.text1': 'Пожалуйста прочитайте данные <a href="/terms"><b>условия и правила</b></a> чтобы убедиться в том, что Вы можете участвовать в акции. Для участия в акции нет необходимости в совершении каких-либо покупок.',
    'get.text2': 'Жеребьевка будет проходить с использованием технологии блокчейн. Победители будут выбраны смарт-контрактами без вмешательства человека, руководствуясь только математикой и компьютерным кодом. Это должно обеспечить полную прозрачность и независимость. Жеребьевка состоится в Эстонии согласно соответствующим правилам ЕС.',
  ...
  'prize.3': '3-й Приз',
    ...
    "ethusdt_description": "ETH в USDT ✅ Конвертер Эфириум в Tether ➤ Выгодные курсы и рыночные цены в режиме реального времени ➤ Быстро, надежно, проверено ➤ Полная поддержка 24/7",
    "ethbtc_title": "ETH в BTC. Конвертация Эфириума и Биткоина | Emirex.com",
    "ethbtc_description": "ETH в BTC ✅ Конвертер Эфириум в Биткоин ➤ Выгодные курсы и цены в режиме реального времени ➤ Покупка и продажа: быстро, надежно, проверено ➤ Поддержка 24/7",
    "emrxbtc_title": "EMRX в BTC. Конвертация EMRX | Emirex.com",
    "emrxbtc_description": "EMRX в BTC ✅ Конвертер EMRX. Онлайн курс ➤ Выгодные рыночные цены в режиме реального времени ➤ Покупка и продажа: быстро, надежно, проверено ➤ Поддержка 24/7",
