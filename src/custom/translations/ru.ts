...
export const ru: LangType = {
 ...
 Если Вы забыли свой Секретный ключ, удалите его и создайте новую пару ключей.',
  ...
  'page.body.wallets.tabs.deposit.fiat.levelLink': 'Please upgrade your verification level',
    ...
    'page.referal.topbanner.ieo_started': 'Emirex IEO началось!',
    'page.referal.topbanner.dont_miss_chance': 'Не упусти свой шанс!',
    'page.referal.learn_more': 'Узнать больше',
    'page.referal.bottombanner.ieo': 'Emirex IEO',
    'page.referal.bottombanner.accepted_cur': 'Accepted currencies to purchase the EMRX:',
