...
export const ru: LangType = {
 ...
 Если Вы забыли свой Секретный ключ, удалите его и создайте новую пару ключей.',
  ...
  'page.body.wallets.tabs.deposit.fiat.levelLink': 'Please upgrade your verification level',
    ...
    'page.referal.bottombanner.accepted_cur': 'EMRX можно приобрести за валюты:',
    'page.referal.bottombanner.IEO_token_price': 'Цена токена на IEO',
    'page.referal.bottombanner.IEO_max_supply': 'Максимальный объём IEO',
    'page.referal.bottombanner.IEO_start_date': 'Дата начала IEO',
    'page.referal.bottombanner.hard_cap': 'Hard Cap',
    'page.referal.bottombanner.token_distrib_date': 'Дата дистрибьюции токенов',
    'page.referal.bottombanner.2_weeks_after_IEO': '2 weeks after end of IEO',
