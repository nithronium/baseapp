...
export const zh = {
    ...
    footer_headers_terms_of_use_defi: "DeFi Terms of Use",
    footer_headers_privacy: "隐私",
    footer_headers_KYC_AML_policy: "KYC/ALM政策",
    footer_headers_cookie: "Cookie Policy",
    ...
    ieo_4_title: 'CryptoAds商城的IEO（CARD）',
    ieo_4_description: 'CryptoAds IEO (CRAD). 我们启动了IEO上线. 目前，CryptoAds正在加速增长，并期待结识新客户',
    ieo_5_title: 'Chatello IEO 立即获取',
    ieo_5_description: 'CHA Chatello IEO. 我们启动了IEO上线. 目前，',
    ...
    'buyWithCard.faq.header1': 'Is it safe to buy cryptocurrency?',
    'buyWithCard.faq.text1': 'Yes, it is definitely safe to purchase any cryptocurrency. Emirex is the Middle East largest Crypto Exchange',
    'buyWithCard.faq.header2': 'Which is the best cryptocurrency to buy now?',
    'buyWithCard.faq.text2': 'BTC, LTC, ETH, EMRX - this list is based on the potential of these cryptocurrencies to show sustainable growth in the months ahead.',
    'buyWithCard.faq.header3': 'What can i do with my cryptocurrency?',
    'buyWithCard.faq.text3': 'Сryptocurrency has a wide range of use cases. For example: use crypto to pay for goods or services, send and receive payments at a low cost and at a high speed, invest and earn money, buy real estate',
    'buyWithCard.faq.header4': 'How can I buy Cryptocurrency online?',
    'buyWithCard.faq.text4': 'You can buy cryptocurrency with credit card or debit card, with bank transfer (SWIFT/SEPA) or crypto, with money (make a deposit on your USD/EUR/AED)',
    ...
    'buyWithCard.overlay1.text4': 'The specified volume is calculated based on the volume per 100 USD',
    ...
    'chatello.page.title': 'Chatello 硬币(CHA). 立即获取',
    'chatello.page.description': '在Emirex购买Chatello硬币（CHA）与启发和带动您的全球精英和影响者保持联络 您可以在此处获取Chatello应用程序',
