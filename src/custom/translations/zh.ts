...
export const zh = {
  ...
  'page.body.wallets.whitelist.confirmationModal.body.text': '我们已经给您发送了一封包含确认码的邮件，请在下面输入收到的代码以保存新地址：',
  ...
  'page.body.profile.header.account.content.twoFactorAuthentication.message.1': '下载并安装谷歌身份验证器应用程序',
  ...
  'page.body.profile.header.account.content.twoFactorAuthentication.message.3': '*将此私密信息保存在安全的地方。 此代码可用于从其他设备获得2FA访问。',
  ...
  'page.body.profile.apiKeys.modal.note_content': '为避免资产损失，请勿将您的密钥和私钥告诉他人。 如果您忘记了密钥，请删除现有的并申请新的密钥配对。',
  ...
  'page.header.signUp.modal.body': '要完成注册，请在收件箱中查看电子邮件，以获取进一步的操作说明。 如果找不到邮件，请检查您的垃圾邮件文件夹',
  ...
  'page.body.wallets.tabs.deposit.fiat.bankAddress.sepa.value': 'Vision Exchange Building，Territorials Street，Mriehel，BKR 3000-马耳他',
  ...
  'page.referral.hiw.text2': '您推荐人将能获得2张抽奖券，他们所推荐的人将获得1张礼券。 另外关注社交媒, 进行充值也可以获得礼券！',
  ...
  'get.text2': '抽奖将通过使用区块链技术进行，自动执行的智能合约将在没有人为干扰，仅在数学和计算机代码的指导情况下选择获奖者。 这是为了确保完全透明和独立。 根据欧盟的相关规定，抽奖将在爱沙尼亚进行。',
  ...
  'emrxbtc_description': 'EMRX兑换BTC  Emirex代币（EMRX)交换和兑换成比特币。 实时价格和图表。 全天候全球客服支持。 您将能以最新汇率买卖',
  'ltcbtc_title': 'LTC兑换BTC平台| 价格 | emirex.com',
  'ltcbtc_description': 'LTC兑换BTC交易所。 实时价格和图表。莱特币（LTC）兑换比特币（BTC）的平台。 全天候全球客服支持。 您将能以最新汇率买卖',
  'bchbtc_title': 'BCH兑换BTC。 比特币现金交换平台| Emirex.com',
  'bchbtc_description': 'BCH兑换BTC交易所。 实时价格和图表。 比特现金兑换比特币（BTC）的平台。 全天候全球客服支持。 您将能以最新汇率买卖',
  ...
  'page.body.modal.blockNationality.message': '根据国际和当地金融/加密货币法规，我们目前不向所选国家/地区的公民提供服务。 感谢您的理解。',
  ...
  'page.signup.pwdvalidation.header': '密码必须至少包含',
    'page.signup.pwdvalidation.length': '8个字符',
    'page.signup.pwdvalidation.letters': '至少一个大写字母',
    'page.signup.pwdvalidation.number': '一位数字',
