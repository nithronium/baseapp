...
export const zh = {
    ...
    'page.header.navbar.buy_credit_card': '用信用卡购买',
    'page.header.navbar.earn': '理财',

    'page.header.navbar.download_mobile': '下载APP',
    'page.header.navbar.download': 'App',

    "nav.link.spot": "现货",
    "nav.link.spot.description": "币币交易",
    "nav.link.futures": "期货",
    "nav.link.futures.description": "使用杠杆交易,做多或做空市场",
    "nav.link.margin": "杠杆",
    ...
    "nav.link.emrx-treasure.description": "存款获利。 使用EMRX代币积累财富",
    "nav.link.ieo": "IEO",
    "nav.link.ieo.description": "交易所投资计划",
    "nav.link.staking": "持仓",
    "nav.link.staking.description": "通过存入和持有赚取奖励",
    "nav.link.landing": "起货",
    "nav.link.landing.description": "存入加密货币并获得奖励",
    "nav.link.referral-giveaway": "推荐奖",
    ...
    'page.body.wallets.tabs.deposit.ccy.message.limits1': '您的存款不得超过等于',
    ...
    'page.body.wallets.tabs.deposit.fiat.message.accountName': '请确保您要存入资金的银行账户上的姓名与Emirex账号上的姓名匹配',
    ...
    "page.header.orders_spot": "现货订单",
    "page.header.orders_futures": "期货订单",
    "page.header.orders_margin": "杠杆订单",
    "page.header.history_spot": "现货历史记录",
    "page.header.history_futures": "期货历史记录",
    "page.header.history_margin": "杠杆历史记录",
    "page.header.current_balance": "当前余额",
    "page.header.deposit_withdraw": "充值和提现",
    "page.header.buy_crypto": "购买加密货币",
    ...
    'success.questionnaire.under.review': '您的问卷正在审查中',
    ...
    'account.deposit.not_permitted': '生成存款地址',
    ...
    'page.body.profile.header.account.auth2fa.mfa.text2': '在下一页，将要求您保存',
    'page.body.profile.header.account.auth2fa.mfa.text3': 'MFA代码',
    'page.body.profile.header.account.auth2fa.mfa.text4': '以便您在丢',
    'page.body.profile.header.account.auth2fa.mfa.text5': '失或更换设备的情况下在',
    'page.body.profile.header.account.auth2fa.mfa.text6': '一分钟内可以重',
    'page.body.profile.header.account.auth2fa.mfa.text7': '新获得对',
    'page.body.profile.header.account.auth2fa.mfa.text8': '账号的访问权限, ',
    'page.body.profile.header.account.auth2fa.mfa.text9': '请按照步骤操作。',
    'page.body.profile.header.account.auth2fa.mfa.text10': '请注意，如果无法访问安装的GA(谷歌验证器)应用程序的设备，并且缺少MFA代码，则恢复对该账号的访问最多可能需要',
    'page.body.profile.header.account.auth2fa.mfa.text11': '10天。',
    'page.body.profile.header.account.auth2fa.mfa.text12': ' ',
    'page.body.profile.header.account.auth2fa.mfa.text13': ' ',
    ...
    'page.body.kyc.head.level.fifth': '地址证明',
    ...
    'page.body.wallets.tabs.deposit.fiat.minimal.eur.value.sepa': '5欧元.',
    'page.body.wallets.tabs.deposit.fiat.minimal.eur.value.sepaLess': '不收取交易费',
    ...
    footer_headers_advisory: "顾问",
    footer_headers_products: "产品",
    footer_headers_service: "服务",
    footer_headers_legal: "法律",
    footer_headers_our_services: "我们的服务",
    footer_headers_сommodities: "商品",
    footer_headers_expertise: "专业",
    footer_headers_spot_trade: "现货交易",
    footer_headers_ieo: "IEO",
    footer_headers_referral_program: "推荐计划",
    footer_headers_terms_of_use: "使用条件",
    footer_headers_privacy: "隐私",
    footer_headers_KYC_AML_policy: "KYC/ALM政策",
    footer_headers_knowledge_base: "知识库",
    footer_headers_submit_a_ticket: "提交票证",
    footer_headers_about: "关于",
    footer_headers_emirex_blog: "Emirex博客",
    footer_headers_contact_us: "联系我们",
    ...
    btcaed_title: 'BTC兑AED。UAE（阿拉伯联合酋长国）交易平台 | Emirex.com',
    btcaed_description: 'BTC兑AED的当前汇率计算器。BTC兑United Arab Emirates Dirham（阿联酋迪拉姆）。实时价格和图表。世界当前汇率',
    ethaed_title: 'ETH兑AED。UAE（阿拉伯联合酋长国）的货币转换器 | Emirex.com',
    ethaed_description: 'ETH兑AED的当前汇率计算器。Ethereum兑United Arab Emirates Dirham（阿联酋迪拉姆）。实时价格和图表。世界当前汇率。24/7支持',
    usdtaed_title: 'USDT兑AED。UAE Dirham的货币转换器 | Emirex.com',
    usdtaed_description: 'USDT兑AED的当前汇率计算器。Tether (USDT) 兑UAE Dirham（阿联酋迪拉姆）。实时价格和图表。世界当前汇率。24/7支持',
    btceur_title: 'BTC兑EUR。货币转换器。交易平台 | Emirex.com',
    btceur_description: 'BTC兑EUR的当前汇率计算器。Bitcoin兑Euro (EUR)。实时价格和图表。世界当前汇率。24/7支持',
    etheur_title: 'ETH兑EUR。货币转换器。当当前兑换交易 | Emirex.com',
    etheur_description: 'ETH兑EUR的当前汇率计算器。Ethereum (ETH)兑Euro (EUR)。实时价格和图表。世界当前汇率。由Emirex提供24/7支持',
    btcusd_title: 'BTC兑USD。货币转换器。当前兑换交易 | Emirex.com',
    btcusd_description: 'BTC兑USD的当前汇率计算器。Bitcoin (BTC)兑United States Dollar (USD)。实时价格和图表。世界当前汇率。',
    ethusd_title: 'ETH兑USD。美元 $的货币转换器 | Emirex.com',
    ethusd_description: 'ETH兑USD的当前汇率计算器。Ethereum (ETH)兑United States Dollar (USD)。实时价格和图表。世界当前汇率。',
    usdteur_title: 'USDT兑EUR图表。交易平台 | Emirex.com',
    usdteur_description: 'USDT兑EUR的线上货币转换器。Tether (USDT)兑Euros (EUR)的数量。实时价格和图表。汇率历史记录。您仅需在Emirex双击即可兑换',
    usdtusd_title: 'USDT兑USD。美元 $交易平台 | Emirex.com',
    usdtusd_description: 'USDT兑USD的线上当前汇率计算器。Tether (USDT)兑美元(USD)。实时价格和图表。Emirex的汇率和兑换交易历史记录',
    bchusdt_title: 'BCH/USDT市场。Bitcoin Cash 交易平台 | Emirex.com',
    bchusdt_description: 'BCH/USDT市场和线上汇率计算器。Bitcoin Cash (BCH)兑Tether (USDT)。实时价格和图表。汇率历史记录。24/7 账户访问',
    usdcusdt_title: 'USDC/USDT市场。USD Coin交易平台 | Emirex.com',
    usdcusdt_description: 'USDC/USDT市场和线上汇率计算器。USD Coin (USDC)兑Tether (USDT)。实时价格和图表。汇率历史记录。24/7 账户访问',
    btcusdc_title: 'BTC/USDC市场。货币兑换 | Emirex.com',
    btcusdc_description: 'BTC/USDC市场和线上汇率计算器。Bitcoin (BTC)兑USD Coin (USDC)。实时价格和图表。汇率历史记录。24/7 账户访问',
    t69usdt_title: 'T69兑USDT实时价格、图表 | Emirex.com',
    t69usdt_description: 'T69/USDT 线上货币转换器。Tycoon Chain (T69)兑Tether (USDT)的数量。实时价格和图表。当前汇率计算器、历史数据、新消息及其他功能',
    ...
    maticbtc_title: 'MATIC兑BTC. Matic网络交易 | Emirex.com',
    maticbtc_description: 'MATIC兑BTC（比特币）汇率 ➤ 查阅价格走势，市场和交易信息 ➤ Matic网络图表和最新新闻',
    maticusdt_title: 'MATIC兑USDT. Matic网络价格 | Emirex.com',
    maticusdt_description: 'MATIC / USDT价格，图表，数量 ➤ 查阅市场和交易信息 ➤ Matic网络转换为Tether（USDT） ➤ 立即开始交易',
    zpaebtc_title: 'ZPAYae 兑换为 比特币（BTC). 实时价格和图表| Emirex.com',
    zpaebtc_description: '立即在线将比特币（BTC）转换为ZelaaPay（ZPAYae） ➤ 获取全面信息 ➤ 实时价格和图表 ➤ 选择最好的汇率并立即开始交易',
    chzbtc_title: 'CHZ to BTC. Chiliz Chart | Emirex.com',
    chzbtc_description: 'CHZ/BTC exchange charts ➤ Trade History, price ➤ Convert Chiliz (CHZ) to Bitcoin (BTC) online ➤ Start investing now',
    chzusdt_title: 'CHZ至USDT. Chiliz图表 | Emirex.com',
    chzusdt_description: 'CHZ / USDT交易图表. 交易记录，价格 在线将Chiliz（CHZ）USDT 立即开始投资',
    ethbusd_title: 'ETH/BUSD. 币安美元市场',
    ethbusd_description: 'ETH/BUSD市场. Emirex交易平台上的以太坊兑Binance USD转换器. 实时价格和图表. 选择最好的报价并立即开始交易',
    btcbusd_title: 'BTC/BUSD. 币安美元市场',
    btcbusd_description: 'BTC/BUSD市场. Emirex交易平台上的比特币兑Binance USD转换器. 实时价格和图表. 选择最好的报价并立即开始交易',
    enjbtc_title: '恩金币交换为到BTC（ENJ / BTC） | Emirex.com',
    enjbtc_description: 'ENJ / BTC转换器. 查看恩金币（ENJ）兑比特币（BTC）实时的图表以跟踪最新价格的变化',
    enjusdt_title: '恩金币兑（ENJ / USDT）| Emirex.com',
    enjusdt_description: 'ENJ/USDT转换器. 查看恩金币（ENJ）兑比特币（USDT）实时的图表以跟踪最新价格的变化',
    referral_title: '获取比特币。 加密推荐计划| Emirex.com',
    referral_description: '免费获取比特币。 最好的推荐计划。 加入✅WinWithEmirex的会员计划',
    ieo_title: '首次交易发行（IEO）清单 | Emirex.com',
    ieo_description: '浏览我们加密货币的IEO清单 ➤ 等级：即将发行、活跃、发行中和终止发行 ➤ 获取Emirex所列IEO清单的完整信息',
    ieo_1_title: 'Emirex的IEO等级和详细信息 | Emirex.com',
    ieo_1_description: 'EMRX代币 ➤ 处理中 ✅ 获取EMRX代币的完整信息，包括：IEO详细信息、等级、价格、代币销售策略、分销',
    ieo_2_title: 'T69 coin的IEO等级和详细信息 | Emirex.com',
    ...
    ieo_5_title: 'CryptoAds Marketplace IEO (CRAD) | Emirex.com',
    ieo_5_description: 'CryptoAds IEO (CRAD) ✅ We launched IEO listing ➤ Currently, CryptoAds accelerates its growth and looking forward to meeting new clients',
    ...
    'page.wallets.withdraw.fiat': '注意：如果您汇出的金额超出限额，则将退还资金。',
    activeTickets: '您的激活票',
    ...
    'buyWithCard.title': 'Buy or Sell Cryptocurrency Today | Emirex.com',
    'buyWithCard.description': 'Buy and sell cryptocurrency with credit card (Visa/Mastercard) or USD bank transfer (Sepa/Swift) ✅ The best way to buy crypto in the Middle East',
