...
export const zh = {
    ...
    "nav.link.futures": "Futures",
    "nav.link.futures.description": "Long or short the market with up to leverage",
    ...
    "nav.link.emrx-treasure.description": "Deposit to profit. Build wealth with EMRX Tokens",
    "nav.link.ieo": "IEO",
    "nav.link.ieo.description": "Exchange investment offers",
    "nav.link.staking": "Staking",
    "nav.link.staking.description": "Earn rewards by depositing and holding",
    "nav.link.landing": "Landing",
    "nav.link.landing.description": "Deposit crypto and earn rewards",
    ...
    "page.header.orders_futures": "Futures Orders",
    "page.header.orders_margin": "Margin Orders",
    "page.header.history_spot": "Spot History",
    "page.header.history_futures": "Futures History",
    "page.header.history_margin": "Margin History",
    "page.header.current_balance": "Current Balance",
    "page.header.deposit_withdraw": "Deposit & Withdraw",
    "page.header.buy_crypto": "Buy Crypto",
