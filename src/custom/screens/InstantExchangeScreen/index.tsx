...
import {
    InstantExchangeContainer,
    InstantExchangeInfo,
    InstantExchangeTopInfo,
} from '../../containers/InstantExchange';
...
class InstantExchangeScreenComponent extends React.Component<Props, State> {
    constructor(props) {
        super(props);
        this.state = {
            orderFinished: false,
        ...
        return (
            <div className="pg-buy-with-credit-card">
                ...
                <div className="pg-buy-with-credit-card__container">
                    <div className="instant-exchange__top">
                        <InstantExchangeContainer
...
export const InstantExchangeScreen = injectIntl(connect(mapStateToProps, mapDispatchToProps)(InstantExchangeScreenComponent));
