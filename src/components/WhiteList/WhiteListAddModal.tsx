...
interface ReduxProps {
    whitelistAddError?: CommonError;
    whitelistAddSuccess: boolean;
}
...
class WhiteListAddModalComponent extends React.Component<Props, State> {
    ...
    public componentWillReceiveProps(nextProps: Props) {
        ...
        if ((nextProps.whitelistAddError && !whitelistAddError) ||
            (nextProps.whitelistAddSuccess && !whitelistAddSuccess)) {
            this.props.handleToggleAddAddressModal();
            this.handleClearModalsInputs();
        }

        if (nextProps.whitelistAddSuccess && !whitelistAddSuccess) {
    ...
    public render() {
        ...
        const addModalClass = classnames('cr-modal whitelist-add-address-modal', {
            'whitelist-add-address-modal--coin': type === 'coin',
            'whitelist-add-address-modal--fiat': type === 'fiat',
        });
            ...
            <div className="cr-email-form__options-group">
                <div className="cr-email-form__option">
                    <div className="cr-email-form__option-inner">
                        {this.translate('page.body.wallets.whitelist.addAddressModal.header')}
                        <span
    ...
    private renderAddAddressModalBodyItem = (field: string, optional?: boolean) => {
        ...
        return (
            <div key={field} className={focusedClass}>
                <CustomInput
                    type="text"
                    label={this.translate(`page.body.wallets.whitelist.addAddressModal.body.${field}`)}
                    placeholder={this.translate(`page.body.wallets.whitelist.addAddressModal.body.${field}`)}
                    defaultLabel={field}
...
const mapStateToProps = (state: RootState): ReduxProps => ({
    whitelistAddError: selectBeneficiariesCreateError(state),
    whitelistAddSuccess: selectBeneficiariesCreateSuccess(state),
});
...
// tslint:disable-next-line:no-any
export const WhiteListAddModal = injectIntl(connect(mapStateToProps, mapDispatchToProps)(WhiteListAddModalComponent) as any);
