export const ru = {
    ...
    'page.body.ieo.details.order.content.blur.title': 'Продажа токенов начнется через',
    'page.body.ieo.details.order.content.blur.titleFinished': 'Продажа токенов завершена',
    'page.body.ieo.details.info.startsAt': 'Начнется в',
    'page.body.ieo.details.info.finishesAt': 'Завершится в',
    'page.body.ieo.details.info.finishedAt': 'Завершилось в',
    ...
    'page.body.ieo.history.fees': 'Комиссии',
